          ...
          <Grid item xs={12} md={8}>
            <div style={{ textAlign: 'center' }}>
              <Typography
                variant='h1'
                sx={{
                  fontSize:`${isBelow400px ? '22px' : isBetween400and600px ? '28px' : '36px'}`  ,
                  lineHeight:`${isBelow400px ? '28px' : isBetween400and600px ? '38px' : '46px'}`  ,
              ...
              .map((blog) => (
                <Grid item xs={12} sm={6} md={4} key={blog.id}>
                  <div style={{ padding: '16px' }}>
                    <img src={`/${blog.image}`} alt='blogpost' style={{ width: '100%' }} />
                    <div>
                      <Typography
                        sx={{
                          color: '#000',
                      ...
                      >
                        ...
                        <Grid>
                          <Typography color="#2B63D9" component={Link} to={`/blogs/${blog.id}`}>
                            Read More
                          </Typography>
                        </Grid>
                      </Grid>
