...
This repository houses my solutions to the exercises for the Full Stack Open course, a comprehensive program offered by the University of Helsinki. The course focuses on modern JavaScript-based web development, including React, Redux, Node.js, Express, authentication, and MongoDB.
...
## Part 2 - Communicating with Server from Frontend
